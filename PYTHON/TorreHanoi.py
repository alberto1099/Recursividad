...
def hanoiTexto(n, origen=1, auxiliar=2, destino=3):
    ...
    if n > 0:
        # n-1 discos de la torre origen a la torre auxiliar.
        hanoiTexto(n-1, origen, destino, auxiliar)
        # disco n a la torre destino.
        print("Se mueve el disco %d de torre %d a la torre %d" %
              (n, origen, destino))
        # n-1 discos de la torre auxiliar a la torre final.
        hanoiTexto(n-1, auxiliar, origen, destino)
...
print("*"*25)
modo = int(
    input("Ingrese la opcion deseada:\n\n1) Modo grafico\n2) Modo texto\n\n"))
